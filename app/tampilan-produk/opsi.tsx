...
export default function PackageTabs() {
  ...
  return (
    <div className="fixed right-5 max-w-md bg-white rounded-2xl border-2 border-gray-300 p-4">
      {/* Tabs */}
        ...
        {(['Basic', 'Standard', 'Premium'] as PackageOption[]).map((tab) => (
          <button
            ...
            className={`px-4 py-2 font-semibold ${
              selected === tab ? 'text-white bg-green-500 rounded-t-md' : 'text-gray-500 underline'
            }`}
      ...
      {/* Package Details */}
      <div className="p-4 border rounded-b-xl space-y-3">
      ...
      {/* Continue Button */}
      <button className="mt-4 w-full flex items-center justify-center gap-2 bg-green-500 text-white py-2 rounded-xl hover:bg-green-600 transition">
